...
extern const MIDL_SERVER_INFO FileSystemInterface_ServerInfo;

extern const RPC_DISPATCH_TABLE FileSystemInterface_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE FileSystemInterface___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xae3d1e20,0x19d0,0x4e93,{0x9d,0x6e,0x84,0x41,0x05,0x9a,0x4a,0x1f}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&FileSystemInterface_v1_0_DispatchTable,
    0,
    0,
    0,
    &FileSystemInterface_ServerInfo,
    0x06000000
    };
RPC_IF_HANDLE FileSystemInterface_v1_0_s_ifspec = (RPC_IF_HANDLE)& FileSystemInterface___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const RPC_DISPATCH_FUNCTION FileSystemInterface_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE FileSystemInterface_v1_0_DispatchTable = 
    {
    5,
    (RPC_DISPATCH_FUNCTION*)FileSystemInterface_table
    };
...
static const MIDL_STUB_DESC FileSystemInterface_StubDesc = 
    {
    (void *)& FileSystemInterface___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& FileSystemInterface_ServerInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const RPC_DISPATCH_FUNCTION FileSystemInterface_NDR64__table[] =
    {
    NdrServerCallAll,
    NdrServerCallAll,
    NdrServerCallAll,
...
static const RPC_DISPATCH_TABLE FileSystemInterface_NDR64__v1_0_DispatchTable = 
    {
    5,
    (RPC_DISPATCH_FUNCTION*)FileSystemInterface_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO FileSystemInterface_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&FileSystemInterface_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE FileSystemInterface_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Authenticate,
    (SERVER_ROUTINE)Get_File_Size,
    (SERVER_ROUTINE)Download_File,
    (SERVER_ROUTINE)Upload_File,
    (SERVER_ROUTINE)Delete_File
    };

static const MIDL_SERVER_INFO FileSystemInterface_ServerInfo = 
    {
    &FileSystemInterface_StubDesc,
    FileSystemInterface_ServerRoutineTable,
    interface__MIDL_ProcFormatString.Format,
    (unsigned short *) FileSystemInterface_FormatStringOffsetTable,
    0,
